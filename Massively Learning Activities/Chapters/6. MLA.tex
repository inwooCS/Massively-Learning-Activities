...
\begin{enumerate}
    ...
    \begin{center}
        ...
        \rowcolor[HTML]{196fb4}\centering\textcolor{white}{\large Tier} 
                                & \centering\textcolor{white}{\large Cores} 
                                & \centering\textcolor{white}{\large Memory (GB)} 
                                & \centering\textcolor{white}{\large Minimum/Core (GB)} 
                                \tabularnewline 
        \hline
        SAS Metadata Server & 2 cores       & 16 GB RAM         &  8 GB RAM per core   \\\hline
        SAS Compute Server  & 6 - 8 cores   & 48 - 64 GB RAM    &  8 GB RAM per core   \\\hline
        SAS Mid-Tier Server & 2 cores       & 24 GB RAM         & 24 GB RAM per core   \\\hline
        \end{tabular}
    \end{center}
